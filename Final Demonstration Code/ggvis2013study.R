...
# =================================
# Population in 2013 data collection
# =================================
...
# =================================
# Merging 2013 sampled and population data together
# =================================
...
# 
# producing static population plot
#
...
# ========================================
# Population data 2013 ggvis plot check boxes
# ========================================
...
sampfunc <- function(name){
  ...
  theme_set(theme_grey(base_size=18))
  carr <- popandsim$uniquecarrier[which(popandsim$carrier==name)]

ggplot(popandsim[popandsim$uniquecarrier==carr,],aes(date,sampleavg),size=2.5) +
  coord_cartesian(ylim=c(-20,50)) +
  geom_errorbar(aes(date,ymin=sampleavg-2*sqrt(StdError),ymax=sampleavg+2*sqrt(StdError)),size=1) +
  geom_point(aes(x=date,y=sampleavg),size=2.5) +
